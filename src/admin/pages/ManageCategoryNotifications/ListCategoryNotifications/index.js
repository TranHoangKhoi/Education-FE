...
import styles from './ListCategoryNotifications.module.scss';

const cx = classNames.bind(styles);
function ListCategoryNotifications()
{
    return (
...
export default ListCategoryNotifications;